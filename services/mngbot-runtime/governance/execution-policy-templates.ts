/**
 * services/mngbot-runtime/governance/execution-policy-templates.ts
 *
 * ⚠️ services/discord-adapter/execution-policy-templates.ts와 내용이 동일한
 *    의도적 중복 파일. 수정 시 두 파일을 같이 고칠 것 (INTEGRATION.md 참고).
 *
